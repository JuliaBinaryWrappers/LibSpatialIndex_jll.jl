...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import LibSpatialIndex_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("00e98e2a-4326-5239-88cb-15dcbe1c18d0"))
platforms = [Pkg.Artifacts.unpack_platform(e, "LibSpatialIndex", artifacts_toml) for e in artifacts["LibSpatialIndex"]]
...
if best_platform === nothing
    @debug("Unable to load LibSpatialIndex; unsupported platform $(triplet(platform_key_abi()))")
else

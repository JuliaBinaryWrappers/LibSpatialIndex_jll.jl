# Autogenerated wrapper script for LibSpatialIndex_jll for x86_64-apple-darwin14-cxx11
...
const libspatialindex_c_splitpath = ["lib", "libspatialindex_c.4.dylib"]
...
const libspatialindex_c = "@rpath/libspatialindex_c.4.dylib"


# Relative path to `libspatialindex`
const libspatialindex_splitpath = ["lib", "libspatialindex.4.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libspatialindex = "@rpath/libspatialindex.4.dylib"
